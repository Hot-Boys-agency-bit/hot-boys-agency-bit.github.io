...
<div class="section_header text-center">
	...
	<h2>Разместить анкету</h2>
             ...
             <h4>Внешность</h4>
              ...
              <p><b>Наличие вод.удостоверения</b><Br>
                 <input type="radio"  value="ie"> Есть
                 <input type="radio"  value="opera"> Нет
             </p>
              <p><b>Наличие Визы Шенген</b><br>
                 <input type="radio" value="ie"> Есть
                 <input type="radio"  value="opera"> Нет
              </p>
              <p><b>Наличие визы Англии</b><br>
                 <input type="radio" value="ie"> Есть
                 <input type="radio"  value="opera"> Нет
              </p>
   ...
   <p><input id="ee" class="col-center" type="submit" value="Отправить"></p>
